...
@interface IRAlbumsViewController () <PHPhotoLibraryChangeObserver>
...
@implementation IRAlbumsViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.navigationItem.title = NSLocalizedStringFromTableInBundle(@"albums.title", @"IRImagePickerController", self.imagePickerController.assetBundle, nil);
...
{
    IRAssetsViewController *assetsViewController = segue.destinationViewController;
...
{
    if ([self.imagePickerController.delegate respondsToSelector:@selector(ir_imagePickerControllerDidCancel:)]) {
        [self.imagePickerController.delegate ir_imagePickerControllerDidCancel:self.imagePickerController];
    }
}
...
{
    IRAlbumCell *cell = [tableView dequeueReusableCellWithIdentifier:@"AlbumCell" forIndexPath:indexPath];
